...
var mongoTypes = {
  ...
  5: ['binData', function (a) {
    return a && a instanceof ArrayBuffer || a.toString() === "[object ArrayBuffer]" ||
           a instanceof Uint8Array || a instanceof Uint8ClampedArray ||
           a instanceof Uint16Array || a instanceof Uint32Array ||
           a instanceof Int8Array || a instanceof Int16Array ||
  ...
  9: ['date', function (a) {
    return a instanceof Date || a.constructor === Date;
  }],
  10: ['null', function (a) {
    return a === null;
  }],
  11: ['regex', function (a) {
    return a instanceof RegExp || a.constructor === RegExp;
  }],
  16: ['int', function (a) {
...
Filtr.comparators = {
  ...
  , $type: function (a, b) {
    var type = mongoTypes[b];
    if(typeof type === 'undefined'){
      for (var k in mongoTypes) {
        var alias = mongoTypes[k][0];
